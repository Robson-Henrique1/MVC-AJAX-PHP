...
class EntradasModel
{
    ...
    {
        $sql = "SELECT Entradas.id_entrada,Tipos_Entradas.id_tipo_entrada, Tipos_Entradas.nome, Entradas.descricao, Entradas.data_hora_entrada,Entradas.valor,SUM(Entradas.valor) as 'total'
        FROM Entradas
